<div class="card text-center p-1 item border-0 mb-2">
    <style>
    ...
    <a class="nav-link text-dark py-0" href="{{ url('item/' . $item->id)}}">
        <div class="item-big-image item-image-{{ $item->category->id ?? '' }}-{{$item->id}} card-img-top img-thumbnail">
            @if ($item->quantity === 0)
